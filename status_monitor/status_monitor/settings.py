...
SECRET_KEY = "django-insecure-%^(3sez!m!d$5$scgki+#v()sovg#=-xkma04)dpo=e%%p$cq("
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '*',  # Permite todos os hosts, use com cautela em produção
]
...
# Ajuste do fuso horário para exibição/localização correta
